...
UPDATE_LOG = [
    {
        "date": "2026-06-26",
        "items": [
            "**유사업체 조사 대폭 확장(9곳+)** — 잉글리시에그·브레인나우·튼튼영어·웅진북클럽·"
            "윤선생·리딩게이트 등 '콘텐츠·교재 판매 + 액티비티북 + 회원 활동' 모델",
            "**유사업체 운영규정 수집** — 보강 규정·월간/액티비티 플랜·수업시간(주1회·40분)·"
            "빈도 (지점 블로그 출처 URL 포함). ★잉글리시에그 *'학원 아님 = 교구 주문'* 명시 확보",
            "**브레인나우 학부모 후기 활동사진** — 단어카드·교구 놀이 실사진(애플베리 "
            "'단어카드→액티비티북→놀이' 모델과 동일 입증)",
            "**유사업체 블로그 직접 크롤링(결과)** — 브레인나우 공식·학부모후기, 웅진북클럽, "
            "튼튼 베이비리그 블로그 + 에그/브나/튼튼 **지점 블로그**(보강규정·월간플랜·수업시간·주N회·6~9세). "
            "수집한 출처 URL은 모두 *수집 자료 → :mag: 업계조사*에 적재(클릭 열람)",
            "**과학(영어 STEAM) 유사업체** — 아이크미 English Science(워드카드+워크북+실험)·"
            "CLASS101·꾸그 → Science 2의 8·9세 콘텐츠 포지셔닝 근거",
            "**리딩톡 실제 회원관리 화면(구독 173명)** 마스킹 적재 + 상세페이지·단어카드패키지 보강",
            "벡터 DB 재인덱싱(수집 자료 120여 건 / 청크 350+)",
        ],
    },
    {
        "date": "2026-06-25",
